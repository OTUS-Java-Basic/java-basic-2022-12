...
public class TreeMapDemo {
    public static void main(String[] args) {
        ...
        System.out.println("firstEntry() = " + map.firstEntry()); // первый элемент
        System.out.println("lastEntry() = " + map.lastEntry()); // последний элемент
        System.out.println("headMap(5) = " + map.headMap(5)); // меньше ключа
        System.out.println("tailMap(6) = " + map.tailMap(6)); // больше и равно ключу
        System.out.println("subMap(5, 8) = " + map.subMap(5, 8)); // 5 <= key < 8
    }
}
